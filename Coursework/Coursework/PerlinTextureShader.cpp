...
PerlinTextureShader::PerlinTextureShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd)
{
	initShader(L"Perlin_vs.cso", L"Perlin_ps.cso");
}


PerlinTextureShader::~PerlinTextureShader()
{
